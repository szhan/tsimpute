...
@click.option("--num_threads", "-t", type=int, default=1, help="Number of threads (default = 1).")
...
def parse_vcf_file(
    ...
    vcf = read_vcf.get_vcf(
        in_vcf_file, seq_name=seq_name, left_coord=left_coord, right_coord=right_coord, num_threads=num_threads
    )
