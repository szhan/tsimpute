...
# cytoband 20.p12.1
chr = "20"
length_focal_region = math.ceil(64_444_167 * 0.10)
...
query_ids = np.random.choice(np.arange(sd.num_individuals), query_size)
ref_ids = set(np.arange(sd.num_individuals)) - set(query_ids)
